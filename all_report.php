                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card bg-c-blue order-card">
                                    ...
                                    <div class="card-block">
                                        <h4 class="text-right"><i class="fa fa-solid fa-users f-left"></i><span>Customer Registration Details</span></h4>
                                    </div></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-c-yellow order-card">
                                    ...
                                    <div class="card-block">
                                        <h4 class="text-right"><i class="fa fa-solid fa-users f-left"></i><span>Customer Investment Details</span></h4>
                                    </div></a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card bg-c-blue order-card">
                                    ...
                                    <div class="card-block">
                                        <h4 class="text-right"><i class="fa fa-solid fa-users f-left"></i><span>Individual Customer Payment Details</span></h4>
                                    </div></a>
                                </div>
                            </div>
