                                    ...
                                    <div class="group-form col-md-3" id="namewise">
                                        ...
                                        <?php
                                            ...
                                            if($_SESSION['endtime']<date('Y-m-d h:i:s'))
                                            {
                                                ...
                                                {
                                                    ?>
                                                        <a href="coading.php?stop=stop" onclick="return confirm('Are you sure..?');" class="btn btn-danger" type="reset">Stop</a>
                                                    <?php
                                                }
                                                else
                                                {
                                            ...
                                            {
                                                ?>
                                                        <a href="coading.php?stop=stop" onclick="return confirm('Are you sure..?');" class="btn btn-sm btn-danger col-md-12" type="reset">Stop</a>
                                                <?php
                                            }
                                        ?>
                                    </div>
